...
public class RotationInventory : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        transform.rotation = Quaternion.Euler(constRotation.x, transform.parent.rotation.eulerAngles.y, constRotation.z); // Tutaj zablokowaæ 
...
//TODO Zablokowaæ ca³kowicie rotacje 